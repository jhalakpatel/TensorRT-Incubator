...
from sam2.modeling.sam2_utils import get_1d_sine_pe, TorchMLP, select_closest_cond_frames
    ...
    def _build_sam_heads(self):
        ...
        if self.use_obj_ptrs_in_encoder:
            ...
            if self.use_mlp_for_obj_ptr_proj:
                self.obj_ptr_proj = TorchMLP(self.hidden_dim, self.hidden_dim, self.hidden_dim, 3)
        else:
